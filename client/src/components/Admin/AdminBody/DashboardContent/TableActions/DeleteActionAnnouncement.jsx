...
const DeleteAction = ({ record }) => {  
  ...
  const [modalTextDelete, setModalTextDelete] = React.useState('Do you really want to delete this announcement?');

  const deleteClient = async () => {
    const result = await fetch(`/announcement/${record}`, {
      method: 'DELETE',
  ...
  const deleteModal = () => {
    setModalTextDelete("Do you really want to delete this announcement?");
    setVisibleDelete(true);
  };

  const deleteOk = () => {
    setModalTextDelete('Deleting Announcement...');
